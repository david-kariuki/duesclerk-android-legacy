...
import com.duesclerk.classes.custom_views.dialog_fragments.bottom_sheets.BottomSheetFragment_EmailNotVerified;
                    ...
                    if (!error) {
                        ...
                        if (updated) {
                            ...
                            CustomToast.infoMessage(mContext,
                                    DataUtils.getStringResource(mContext,
                                            R.string.msg_profile_updated_successfully), false,
