...
public class InputFiltersUtils {
     ...
     * @return boolean
     */
    public static boolean checkEmailAddressValidNotify(Context context,
                                                       @NonNull EditText editText) {
        boolean valueAcceptable = false;
     ...
     * @return boolean
     */
    public static boolean checkPhoneNumberValidNotify(Context context, @NonNull EditText editText) {
        boolean valueAcceptable = false;
     ...
     * @return boolean
     */
    public static boolean checkPasswordLengthNotify(Context context, @NonNull EditText editText) {
        boolean valueAcceptable = false;
        if (Objects.requireNonNull(editText.getText()).length() == 0) {
            // Toast Error Message
            CustomToast.errorMessage(context, DataUtils.getStringResource(context,
     ...
     * @return boolean
     */
    public static boolean checkCountryLengthNotify(Context context, @NonNull EditText editText) {
        boolean valueAcceptable = false;
        if (!(Objects.requireNonNull(editText.getText()).length() > 0)) {
            // Toast Error Message
            CustomToast.errorMessage(context, DataUtils.getStringResource(context,
     ...
     * @return boolean
     */
    public static boolean checkGenderLengthNotify(Context context, @NonNull EditText editText) {
        boolean valueAcceptable = false;
        if (!(Objects.requireNonNull(editText.getText()).length() > 0)) {
            // Toast Error Message
            CustomToast.errorMessage(context, DataUtils.getStringResource(context,
     ...
     * @return boolean
     */
    public static boolean checkDateOfBirthLengthNotify(Context context,
                                                       @NonNull EditText editText) {
        boolean valueAcceptable = false;
        if (!(Objects.requireNonNull(editText.getText()).length() > 0)) {
            // Toast Error Message
